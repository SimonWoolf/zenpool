...
var $author$project$Main$calculateMaxEventEffectTime = function (_v0) {
	var maxX = _v0.a;
	var maxY = _v0.b;
...
var $author$project$Main$viewportToDimensions = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
...
var $author$project$Config$tickLengthMs = 50;
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2($elm$time$Time$every, $author$project$Config$tickLengthMs, $author$project$Main$Tick)
			]));
};
...
var $author$project$Main$touchCoordsToGridCoords = function (_v0) {
	var h = _v0.a;
	var v = _v0.b;
	return _Utils_Tuple2(
...
var $author$project$Main$isActiveEvent = F2(
	function (_v0, _v1) {
		var now = _v0.now;
		var maxEventEffectTime = _v0.maxEventEffectTime;
		var eventTime = _v1.c;
...
var $author$project$Grid$eventToSource = F3(
	function (now, _v0, _v1) {
		...
		var maxY = _v0.b;
		var index = _v1.a;
		var maybeCoords = _v1.b;
		var eventTickTime = _v1.c;
		...
		var coords = A2(
			...
			maybeCoords);
		var angle = $author$project$Grid$scaleIntToFloat(
			$author$project$Grid$lehmerNext(seed)) * (2 * $elm$core$Basics$pi);
		return {ago: ticksSinceEvent, angle: angle, srcColour: eventBaseColour, srcCoords: coords};
	});
...
var $author$project$Grid$floatMod1 = function (x) {
	return x - $elm$core$Basics$floor(x);
};
var $author$project$Grid$Negative = {$: 'Negative'};
var $author$project$Grid$Positive = {$: 'Positive'};
var $author$project$Grid$sign = function (x) {
	return (x < 0) ? $author$project$Grid$Negative : $author$project$Grid$Positive;
};
var $author$project$Grid$calculateStarDistance = F4(
	function (_v0, _v1, baseAngle, numPoints) {
		var srcX = _v0.a;
		var srcY = _v0.b;
		var pixelX = _v1.a;
		var pixelY = _v1.b;
		var y = pixelY - srcY;
		var x = pixelX - srcX;
		var thetaRad = function () {
			var _v2 = _Utils_Tuple2(
				$author$project$Grid$sign(x),
				$author$project$Grid$sign(y));
			if (_v2.a.$ === 'Negative') {
				if (_v2.b.$ === 'Positive') {
					var _v5 = _v2.a;
					var _v6 = _v2.b;
					return ($elm$core$Basics$pi / 2) - $elm$core$Basics$atan(x / y);
				} else {
					var _v7 = _v2.a;
					var _v8 = _v2.b;
					return $elm$core$Basics$pi + $elm$core$Basics$atan(y / x);
				}
			} else {
				if (_v2.b.$ === 'Positive') {
					var _v3 = _v2.a;
					var _v4 = _v2.b;
					return $elm$core$Basics$atan(y / x);
				} else {
					var _v9 = _v2.a;
					var _v10 = _v2.b;
					return ((3 * $elm$core$Basics$pi) / 2) - $elm$core$Basics$atan(x / y);
				}
			}
		}();
		var thetaRadAdjusted = thetaRad + baseAngle;
		var euclideanDistance = $elm$core$Basics$sqrt(
			A2($elm$core$Basics$pow, x, 2) + A2($elm$core$Basics$pow, y, 2));
		var angleBetweenPointsRad = (2 * $elm$core$Basics$pi) / numPoints;
		var thetaPoints = thetaRadAdjusted / angleBetweenPointsRad;
		var thetaPointsMod1 = $author$project$Grid$floatMod1(thetaPoints);
...
var $author$project$Grid$calculateNominalDistance = F3(
	function (srcCoords, pixelCoords, angle) {
		...
		if (_v0.$ === 'Circle') {
			...
			var numPoints = _v0.a;
			return A4($author$project$Grid$calculateStarDistance, srcCoords, pixelCoords, angle, numPoints);
		}
	});
...
var $author$project$Grid$calcPixColourForSource = F3(
	function (pixelCoords, _v0, accColour) {
		var srcCoords = _v0.srcCoords;
		var ago = _v0.ago;
		var srcColour = _v0.srcColour;
		var angle = _v0.angle;
		var nominalDistance = A3($author$project$Grid$calculateNominalDistance, srcCoords, pixelCoords, angle);
...
var $author$project$Grid$calculatePixelColour = F2(
	function (sources, coord) {
		return $mdgriffith$elm_ui$Element$fromRgb(
			A3(
				$elm$core$List$foldl,
				$author$project$Grid$calcPixColourForSource(coord),
				$author$project$Grid$rawBlack,
				sources));
	});
...
var $author$project$Grid$makeNode = F2(
	function (sources, coord) {
		return A2(
